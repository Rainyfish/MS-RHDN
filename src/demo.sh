...
python main.py --template RDID_RES --save RDID_RES --scale 2 --reset --save_results --patch_size 96 --pre_train /home/msn/model_best.pt
python main.py --template RDID_RES --save RDID_RES --scale 4 --reset --save_results --patch_size 192 --pre_train /home/msn/model_best.pt




python main.py --template RDID_RES --model RDID_RES --scale 4 --pre_train /home/yyt/Python/model_4/model_best.pt  --test_only --save_results  --dir_data /home/yyt/DIV2K/ --save RDID_4_test_self --data_test Manga109 -
